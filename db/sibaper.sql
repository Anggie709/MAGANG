...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Feb 2020 pada 02.11
...
(1, 0, 'Sistem', 'sistem', 1, 'settings', 1, '1'),
...
(2, 1, '', 'Pengelola Barang', 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 1, '', '', NULL, '2020-02-22', NULL, '');
...
--
ALTER TABLE `yk_menu`
  MODIFY `MenuId` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT untuk tabel `yk_menu_aksi`
--
ALTER TABLE `yk_menu_aksi`
  MODIFY `MenuAksiId` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;
